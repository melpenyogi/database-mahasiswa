...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-uppercase">
        <div class="container">
            <a class="navbar-brand" href="home.html">DATABASE | MAHASISWA </a>
    ...
    <div class="container">
        <div class="row my-2">
            <div class="col-md">
                <h3 class="text-center fw-bold">Database Mahasiswa</h3>
                <hr>
            </div>
        </div>
        <div class="row my-2">
                    ...
                    <tbody>
                        ...
                        <?php foreach ($siswa as $row) : ?>
                            <tr>
                                ...
                                <td><?= $row['semester']; ?></td>
                                <td>
                                    <button class="btn btn-success btn-sm text-white detail" data-id="<?= $row['nim']; ?>" style="font-weight: 600;"><i class="bi bi-eye"></i>&nbsp;Detail</button> |
        ...
        <div class="modal-dialog modal-dialog-scrollable modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title fw-bold" id="detail">Detail Data Mahasiswa</h5>
...
<footer>
  <nav class="padding">
     <div class="text-center text-default bg-secondary">
